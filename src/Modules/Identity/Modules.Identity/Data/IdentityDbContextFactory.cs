...
/// <summary>
/// Design-time factory: <c>dotnet ef migrations add</c> usa esta entrada para construir el
/// <see cref="IdentityDbContext"/> sin levantar el grafo DI completo del Host. Sin este
/// factory, EF intenta resolver <c>ISaveChangesInterceptor</c> (scoped) desde el root provider
/// durante el callback de <c>AddDbContextWithWolverineIntegration</c> y aborta.
/// </summary>
