...
namespace FSH.Starter.Migrations.PostgreSQL.Parties
{
    ...
    [Migration("20260620092054_Parties_PartyRelationship")]
    partial class Parties_PartyRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.Modules.Parties.Domain.CustomFields.CustomFieldDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsDefaultValueEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("TenantId", "EntityType", "ApiSlug")
                        .IsUnique()
                        .HasDatabaseName("ix_customfielddef_slug")
                        .HasFilter("\"Activo\" = TRUE");

                    b.ToTable("CustomFieldDefinitions", "parties");
            ...
            modelBuilder.Entity("FSH.Modules.Parties.Domain.Relationships.PartyRelationship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("ContactFunctionCode")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("TenantId", "TargetPartyId")
                        .IsUnique()
                    ...
                    b.OwnsOne("FSH.Modules.Parties.Domain.FiscalData", "FiscalData", b1 =>
                        {
                            ...
                            b1.Property<string>("EmailFacturacion")
                                .HasMaxLength(256)
                                .HasColumnType("character varying(256)")
                                .HasColumnName("FiscalData_EmailFacturacion");
                    ...
                    b.OwnsOne("FSH.Modules.Parties.Domain.LegalRepresentative", "LegalRepresentative", b1 =>
                        {
                            ...
                            b1.Property<string>("Apellidos")
                                ...
                                .HasMaxLength(120)
                                .HasColumnType("character varying(120)")
                                .HasColumnName("RepLegal_Apellidos");

                            b1.Property<string>("Celular")
                                .HasMaxLength(32)
                                .HasColumnType("character varying(32)")
                                .HasColumnName("RepLegal_Celular");

                            b1.Property<string>("Email")
                                .HasMaxLength(256)
                                .HasColumnType("character varying(256)")
                                .HasColumnName("RepLegal_Email");

                            b1.Property<bool>("EsPEP")
                                .HasColumnType("boolean")
                                .HasColumnName("RepLegal_EsPEP");

                            b1.Property<string>("Nombres")
                                .IsRequired()
                                .HasMaxLength(120)
                                .HasColumnType("character varying(120)")
                                .HasColumnName("RepLegal_Nombres");

                            b1.Property<string>("NumeroIdentificacion")
                                .IsRequired()
                                .HasMaxLength(64)
                                .HasColumnType("character varying(64)")
                                .HasColumnName("RepLegal_NumeroIdentificacion");

                            b1.Property<string>("Telefono")
                                .HasMaxLength(32)
                                .HasColumnType("character varying(32)")
                                .HasColumnName("RepLegal_Telefono");

                            b1.Property<string>("TelefonoExtension")
                                .HasMaxLength(16)
                                .HasColumnType("character varying(16)")
                                .HasColumnName("RepLegal_TelefonoExtension");

                            b1.Property<short>("TipoIdentificacion")
                                .HasColumnType("smallint")
                                .HasColumnName("RepLegal_TipoIdentificacion");
