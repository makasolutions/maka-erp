...
- **Principio de Modelado.** Las fuentes de referencia (Effi, Mercately, Kommo, Odoo, Frappe) son INSUMOS, no PLANOS. Normalización estricta (≥3FN) + contraste obligatorio contra Odoo y Frappe (código real, no memoria) en cada SPEC de entidad central. Ver `_modeling-principles.md`.
