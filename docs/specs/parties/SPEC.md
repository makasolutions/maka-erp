...
| &nbsp;&nbsp;· **PR-D5** features dual-write + lectura interna de v2 (4 sub-PRs) | ⏳ **En curso** |
...
| &nbsp;&nbsp;&nbsp;&nbsp;· **D5b** dual-write Credit→Account+movimientos | ⬜ Pendiente |
| &nbsp;&nbsp;&nbsp;&nbsp;· **D5c** dual-write FiscalData + CIIU | ⬜ Pendiente |
| &nbsp;&nbsp;&nbsp;&nbsp;· **D5d** lectura: Get/GetParties exponen v2 aditivamente | ⬜ Pendiente |
